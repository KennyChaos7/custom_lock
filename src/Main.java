...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.valueOf(mStringBlockQueue.poll()));
        System.out.println(String.valueOf(mStringBlockQueue.toString()));
        System.out.println(String.valueOf(mStringBlockQueue.get(2).toString()));
        System.out.println(String.valueOf(mStringBlockQueue.toString()));
        System.out.println(String.valueOf(mStringBlockQueue.contains("ggg")));
        System.out.println(String.valueOf(mStringBlockQueue.contains("ccc")));
        mStringBlockQueue.clear();
        System.out.println(String.valueOf(mStringBlockQueue.isEmpty()));
        System.out.println(String.valueOf(mStringBlockQueue.toString()));
